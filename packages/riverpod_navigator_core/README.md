...
### "Riverpod navigator core" is a dart package that solves the following:
...
The missing *navigationStackProvider* connection to Flutter Navigator 2.0 to *RouterDelegate* is not not relevant now.
And it's quite simple, as shown in the [DartPad example](https://dartpad.dev/?id=970ba56347a19d86ccafeb551b013fd3).

## [Riverpod navigator](https://github.com/PavelPZ/riverpod_navigator/tree/main/packages/riverpod_navigator)

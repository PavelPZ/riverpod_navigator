// ignore_for_file: prefer_final_fields, prefer_final_locals, avoid_renaming_method_parameters, sort_constructors_first, annotate_overrides, prefer_const_constructors_in_immutables, unnecessary_null_comparison
...
class BookRouterDelegate extends RouterDelegate<BookRoutePath> with ChangeNotifier, PopNavigatorRouterDelegateMixin<BookRoutePath> {
  ...
  BookRoutePath get currentConfiguration =>
      _selectedBook == null ? BookRoutePath.home() : BookRoutePath.details(books.indexOf(_selectedBook as Book));
  ...
  Widget build(BuildContext context) {
    return Navigator(
      ...
      pages: [
        ...
        if (_selectedBook != null) BookDetailsPage(book: _selectedBook as Book)
      ],
  ...
  Future<void> setNewRoutePath(BookRoutePath path) async {
    if (path.isDetailsPage) {
      _selectedBook = books[path.id as int];
    }
  }
